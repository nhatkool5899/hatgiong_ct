                ...
                <a href="/quanly/sanpham">
                    <div class="report-box zoom-in">
                        <div class="box p-5">
                            ...
                            <div class="text-3xl font-medium leading-8 mt-6">{{$countSanpham}}</div>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="/quanly/tintuc">
                    <div class="report-box zoom-in">
                        <div class="box p-5">
                            ...
                            <div class="text-3xl font-medium leading-8 mt-6">{{$countTintuc}}</div>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y">
                <a href="/quanly/kythuat">
                    <div class="report-box zoom-in">
                        <div class="box p-5">
                            <div class="flex">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="report-box__icon text-primary">
                            ...
                            <div class="text-3xl font-medium leading-8 mt-6">{{$countKythuat}}</div>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="/quanly/lienhe">
                    <div class="report-box zoom-in">
                        <div class="box p-5">
                            ...
                            <div class="text-3xl font-medium leading-8 mt-6">{{$countLienhe}}</div>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="/quanly/daily">
                    <div class="report-box zoom-in">
                        <div class="box p-5">
                            ...
                            <div class="text-3xl font-medium leading-8 mt-6">{{$countDaily}}</div>
                        </div>
                    </div>
                </a>
            </div>
