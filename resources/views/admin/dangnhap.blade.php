        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                <a href="/dangnhap" class="-intro-x flex items-center pt-5">
                    <img alt="Logo" class="w-6" id="logohead" src="http://hatgiongcantho.vn/static/media/logo.a1a607a2.png">
                    <span class="text-white text-lg ml-3 h1">Hạt giống Cần Thơ</span>
                </a>
                <div class="my-auto">
                    <img alt="Midone - HTML Admin Template" class="-intro-x w-1/2 -mt-16" src="{{asset('CSS/admin/images/illustration.svg')}}">
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">
                        Chào mừng bạn đến với trang <strong>quản trị viên</strong> !</div>
                    <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">Quản lí trang Hạt giống Cần Thơ</div>
                </div>
            </div>
            <!-- END: Login Info -->
            <!-- BEGIN: Login Form -->
                ...
                <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    <form method="POST" action="/dangnhap">
                        ...
                        <div class="intro-x mt-8">
                            <input name="email" type="email" class="intro-x login__input form-control py-3 px-4 block" placeholder="Địa chỉ email" autofocus required>
                        </div>
                        <div class="intro-x mt-8">
                            <input name="password" type="password" class="intro-x login__input form-control py-3 px-4 block mt-4" placeholder="Mật khẩu" required>
                        </div>
